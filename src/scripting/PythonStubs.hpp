...
// This contains the entire boilerplate for the Python autocompletion.
// Whenever you update your Pybind11 bindings, update this string too!

const std::string FOXVOID_PYI_CONTENT = R"(
